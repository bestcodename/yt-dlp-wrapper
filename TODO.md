...
2. usb:setup add multi usb drive (destination only) support

3. add support for user provided playlist aliases (e.g. defined by a specific comment before the playlists url in the
   url file)

4. playlists:sync add option to group playlist files inside downloads/playlists in directories in different ways.
...
5. usb:setup look into VentoyPlugson
...
6. update project name description and url to something more fitting (e.g. DJ USB Tools)

7. use symfony console sections to improve cli output
